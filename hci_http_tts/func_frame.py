...
import time
import json
import hci_http_func_kit.xls_helper
from hci_http_func_kit.hci_helper import HttpHelper
...
class HttpFuncFrame():
    def __init__(self, 
        ...
        self._filter = []
        self._funcs = funcs
        self._func_test = hci_http_func_kit.xls_helper.load_data_by_excel_file(self._excel_file)
    ...
    def run(self):
        ...
        if self._write_result:
            ...
            pass_count = hci_http_func_kit.xls_helper.write_result_to_excel_file(self._excel_file, self._func_test)
            #数据
